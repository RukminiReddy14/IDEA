# IDEA
IDEA: Intelligent Digital Educational Agent
...
System Architecture
PDF Upload and Validation – Filters for cryptocurrency-related documents
Text Extraction and Embedding – Creates FAISS index with semantic embeddings (all-MiniLM-L6-v2)
Query Handling – Retrieves top-k relevant chunks
LLM Response Generation – Augments prompts with retrieved context and generates accurate answers
Evaluation Framework – Compares models and approaches on performance, speed, and accuracy
